...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Background transparency toggle based on scroll depth
          ...
          >
            <ul className="flex flex-col p-6 gap-2">
              ...
              >
                <a
                  href="/resume.pdf"
                  className="flex items-center justify-center gap-3 p-4 bg-white text-black rounded-xl font-bold text-lg hover:bg-gray-200 transition-all shadow-xl"
                >
                  <Download size={20} />
                  Download Resume
                </a>
